...
enum ProcessSafetyLevel: String, CaseIterable {
    ...
    var color: NSColor {
        ...
        case .monitored: return .systemBlue
        case .restricted: return .systemOrange
        case .forbidden: return .systemRed
        }
    }
    ...
    var systemImage: String {
        ...
        case .monitored: return "eye.circle"
        case .restricted: return "exclamationmark.circle"
        case .forbidden: return "xmark.circle"
        }
    }
}

struct ProcessSafetyResult {
    let level: ProcessSafetyLevel
    let reason: String
    let recommendation: String
    let sipCompliant: Bool
    let timestamp: Date
    
    init(level: ProcessSafetyLevel, reason: String, recommendation: String, sipCompliant: Bool) {
        self.level = level
        self.reason = reason
        self.recommendation = recommendation
        self.sipCompliant = sipCompliant
        self.timestamp = Date()
    }
}
